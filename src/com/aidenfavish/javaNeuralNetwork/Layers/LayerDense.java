...
public class LayerDense implements LayerPass
{
    ...
    public JSONObject getJSON() {
        ...
        ans.put("Name", "com.aidenfavish.javaNeuralNetwork.Layers.LayerDense");
    ...
    public String toString() {
        return "com.aidenfavish.javaNeuralNetwork.Layers.LayerDense (" + (weights.getMatrix().length) + ", " + (weights.getMatrix()[0].length) + ")";
    }
