...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `AidenFavish`, `JavaNeuralNetwork`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Java Neural Network`, `A completely vanilla Java Neural Netowrk inspired by nnfs. Optimized for categorical inference. WORK IN PROGRESS.`
...
2. Clone the repo
   ```sh
   git clone https://github.com/AidenFavish/JavaNeuralNetwork.git
   ```
